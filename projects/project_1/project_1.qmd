...
![](img/scma.png "Smith College Museum of Art banner")
...
[You can find the data files hosted on the course Moodle here](https://moodle.smith.edu/mod/resource/view.php?id=954407). You should unzip the file, and place all of files contained inside the `data/` folder within this project. **You should not share these data files anywhere, including your project Github repo.**
...
**Through Moodle ([Turn in here](https://moodle.smith.edu/mod/assign/view.php?id=955241)):**
