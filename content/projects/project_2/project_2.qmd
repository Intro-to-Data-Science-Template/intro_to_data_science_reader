...
If you would like some inspiration for your analyses, you can look through the [Dollars for Docs](https://projects.propublica.org/docdollars/) series at ProPublica; an archive of all the outputs from this project can be [found here](https://www.propublica.org/series/dollars-for-docs). If you would simply like to re-create one of the analyses you find here with updated or expanded data you can, but I encourage you to follow your own curiosity.
