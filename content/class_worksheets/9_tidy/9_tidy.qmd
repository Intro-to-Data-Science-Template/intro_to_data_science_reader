...
![From [R for Data Science](https://r4ds.had.co.nz/tidy-data.html)](./img/tidy-1.png)
...
char_nums = as.character(c(1,5,8,3,1,5))
char_nums
```
...
![[Data Science Workshops](https://iqss.github.io/dss-workshops/RDataWrangling.html)](img/wide_vs_long.png)
